...
import { getTodayDate, getWeekdaysArray, getLastNDays, WEEKDAY_NAMES } from "@/lib/utils";
import type { Task, TaskCompletion } from "@/lib/types";
import TaskItem from "@/components/TaskItem";
import CompletionCharts from "@/components/CompletionChart";
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Charts */}
      <CompletionCharts weeklyData={weeklyChartData} monthlyData={monthlyChartData} />
